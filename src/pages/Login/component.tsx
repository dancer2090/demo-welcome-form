...
function Copyright() {
  return (
    <Typography variant="body2" color="textSecondary" align="center">
      {'Copyright © '}
      <Link color="inherit" target="_blank" href={process.env.REACT_APP_MAIN_WEBSITE_URL}>
        frontback.org
      </Link>{' '}
...
export default function SignIn() {
  ...
  function validateForm():boolean {
    ...
    const getPasswordError: string = getPasswordErrors.length ? getPasswordErrors[0] : '';
