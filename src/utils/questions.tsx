...
export const questions: QuestionInterface[] = [
  {
    ...
    options: [
      ...
      {
        key: '3-period',
        alias: 'A small period of time (2 weeks or less) to do the piece of work 100% correctly',
      },
    ],
    answer: {
      value: '3-period',
  ...
  },
  {
    ...
    answer: {
      value: ['1-product-owner', '2-task-leader', '4-product-provider', '5-feedback-analizer'],
      check: (answer: string[], correct: string[]) => answer === correct,
    },
    points: 20,
  },
  {
    ...
    answer: {
      value: ['1-quick-versions', '2-save-time', '3-adaptive-product', '4-small-team', '5-save-money'],
      check: (answer: string[], correct: string[]) => answer === correct,
    },
    points: 30,
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        alias: 'Cooperation with a customer is more important than contract discussion',
      },
      {
        key: '4-cooperation-people',
        alias: 'People and their cooperation are more important than processes and tools',
      },
      {
        key: '5-all',
        alias: "all off above",
